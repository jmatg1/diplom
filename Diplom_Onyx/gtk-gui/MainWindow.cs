...
public partial class MainWindow
{
	...
	protected virtual void Build()
	{
		...
		this.Action3 = new global::Gtk.Action("Action3", global::Mono.Unix.Catalog.GetString("Помощь"), null, null);
		this.Action3.ShortLabel = global::Mono.Unix.Catalog.GetString("Помощь");
		w1.Add(this.Action3, null);
		this.Action4 = new global::Gtk.Action("Action4", global::Mono.Unix.Catalog.GetString("Инструкция"), null, null);
		this.Action4.ShortLabel = global::Mono.Unix.Catalog.GetString("Инструкция");
		w1.Add(this.Action4, null);
		this.Action5 = new global::Gtk.Action("Action5", global::Mono.Unix.Catalog.GetString("О Программе"), null, null);
		this.Action5.ShortLabel = global::Mono.Unix.Catalog.GetString("О Программе");
		w1.Add(this.Action5, null);
		this.Action6 = new global::Gtk.Action("Action6", global::Mono.Unix.Catalog.GetString("О Авторе"), null, null);
		this.Action6.ShortLabel = global::Mono.Unix.Catalog.GetString("О Авторе");
		w1.Add(this.Action6, null);
		this.Action7 = new global::Gtk.Action("Action7", null, null, null);
		w1.Add(this.Action7, null);
		this.Action8 = new global::Gtk.Action("Action8", global::Mono.Unix.Catalog.GetString("Файл"), null, null);
		this.Action8.ShortLabel = global::Mono.Unix.Catalog.GetString("Файл");
		w1.Add(this.Action8, null);
		this.Action12 = new global::Gtk.Action("Action12", global::Mono.Unix.Catalog.GetString("Настройки"), null, null);
		this.Action12.ShortLabel = global::Mono.Unix.Catalog.GetString("Настройки");
		w1.Add(this.Action12, "<Primary><Mod2>s");
		this.Action10 = new global::Gtk.Action("Action10", global::Mono.Unix.Catalog.GetString("Выход"), null, null);
		this.Action10.ShortLabel = global::Mono.Unix.Catalog.GetString("Выход");
		w1.Add(this.Action10, null);
		this.Action13 = new global::Gtk.Action("Action13", global::Mono.Unix.Catalog.GetString("Помощь"), null, null);
		this.Action13.ShortLabel = global::Mono.Unix.Catalog.GetString("Помощь");
		w1.Add(this.Action13, null);
		this.helpAction = new global::Gtk.Action("helpAction", global::Mono.Unix.Catalog.GetString("Инструкция"), null, "gtk-help");
		this.helpAction.ShortLabel = global::Mono.Unix.Catalog.GetString("Инструкция");
		w1.Add(this.helpAction, null);
		this.dialogInfoAction1 = new global::Gtk.Action("dialogInfoAction1", global::Mono.Unix.Catalog.GetString("О программе"), null, "gtk-dialog-info");
		this.dialogInfoAction1.ShortLabel = global::Mono.Unix.Catalog.GetString("О программе");
		w1.Add(this.dialogInfoAction1, "<Primary><Mod2>p");
		this.dialogInfoAction = new global::Gtk.Action("dialogInfoAction", global::Mono.Unix.Catalog.GetString("О Авторе"), null, "gtk-dialog-info");
		this.dialogInfoAction.ShortLabel = global::Mono.Unix.Catalog.GetString("О Авторе");
		w1.Add(this.dialogInfoAction, "<Primary><Mod2>a");
		...
		this.UIManager.AddUiFromString(@"<ui><menubar name='menubar3'><menu name='Action7' action='Action7'/><menu name='Action8' action='Action8'><menuitem name='Action12' action='Action12'/></menu><menu name='Action13' action='Action13'><menuitem name='helpAction' action='helpAction'/><menuitem name='dialogInfoAction1' action='dialogInfoAction1'/><menuitem name='dialogInfoAction' action='dialogInfoAction'/></menu></menubar></ui>");
		...
		global::Gtk.Box.BoxChild w2 = ((global::Gtk.Box.BoxChild)(this.hbox4[this.menubar3]));
		w2.Position = 0;
		w2.Expand = false;
		w2.Fill = false;
		...
		global::Gtk.Box.BoxChild w8 = ((global::Gtk.Box.BoxChild)(this.hbox3[this.LabelSetting]));
		w8.Position = 0;
		w8.Expand = false;
		w8.Fill = false;
		// Container child hbox3.Gtk.Box+BoxChild
		...
		global::Gtk.Box.BoxChild w9 = ((global::Gtk.Box.BoxChild)(this.hbox3[this.LabelTemp]));
		w9.Position = 1;
		w9.Expand = false;
		w9.Fill = false;
		// Container child hbox3.Gtk.Box+BoxChild
		...
		global::Gtk.Box.BoxChild w10 = ((global::Gtk.Box.BoxChild)(this.hbox3[this.LabelMSD]));
		w10.Position = 2;
		w10.Expand = false;
		w10.Fill = false;
		...
		global::Gtk.Box.BoxChild w16 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.comboS]));
		w16.Position = 1;
		w16.Expand = false;
		w16.Fill = false;
		// Container child hbox1.Gtk.Box+BoxChild
		...
		global::Gtk.Box.BoxChild w17 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.butStart]));
		w17.Position = 2;
		w17.Expand = false;
		w17.Fill = false;
		// Container child hbox1.Gtk.Box+BoxChild
		...
		global::Gtk.Box.BoxChild w18 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.butStop]));
		w18.Position = 3;
		w18.Expand = false;
		w18.Fill = false;
		...
		global::Gtk.Paned.PanedChild w21 = ((global::Gtk.Paned.PanedChild)(this.hpaned2[this.vbox2]));
		w21.Resize = false;
		this.vbox1.Add(this.hpaned2);
		global::Gtk.Box.BoxChild w22 = ((global::Gtk.Box.BoxChild)(this.vbox1[this.hpaned2]));
		w22.Position = 1;
		this.Add(this.vbox1);
		if ((this.Child != null))
		{
		...
		this.Action12.Activated += new global::System.EventHandler(this.OnActionSettingsActivated);
		this.helpAction.Activated += new global::System.EventHandler(this.OnHelpActionActivated);
		this.dialogInfoAction1.Activated += new global::System.EventHandler(this.OnDialogInfoAction1Activated);
